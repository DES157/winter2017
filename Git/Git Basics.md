...
- [Git and GitHub for Poets: Part 1 - Introduction](https://youtu.be/BCQHnlnPusY?list=PLRqwX-V7Uu6ZF9C0YMKuns9sLDzK6zoiV) start 
...
- [Git Reference](http://gitref.org/) - concise introduction, consider the first two sections, [_Getting and Creating Projects_](http://gitref.org/creating/) and [_Basic Snapshotting_](http://gitref.org/basic/), to be essential reading.
